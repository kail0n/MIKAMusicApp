        ...
        return (
            <div>
                <div className="biography">
                    <h1>{this.state.name} Sounds</h1>
                    <h3>{this.state.genre} Musician</h3>
                </div>
